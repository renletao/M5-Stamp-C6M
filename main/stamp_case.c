...
void stamp_stm32_test_case_17(stamp_stm32_t *dev)
{
    gpio_config_t io_conf = {
        .pin_bit_mask = (1ULL << GPIO_INPUT_IO_2),  // 选择GPIO2
    ...
    gpio_config(&io_conf);
    while (1) {
        int level = gpio_get_level(GPIO_INPUT_IO_2);
...
{
    static const gpio_num_t led_pins[] = {GPIO_NUM_5, GPIO_NUM_6,  GPIO_NUM_7,  GPIO_NUM_14, GPIO_NUM_15, GPIO_NUM_3,
                                          GPIO_NUM_4, GPIO_NUM_23, GPIO_NUM_22, GPIO_NUM_21, GPIO_NUM_20};
